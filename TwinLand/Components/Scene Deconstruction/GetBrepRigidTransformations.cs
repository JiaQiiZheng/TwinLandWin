...
{
    public class GetBrepRigidTransformations : TwinLandComponent
    {
        /// <summary>
        /// Initializes a new instance of the GetBrepRigidTransformations class.
        /// </summary>
        public GetBrepRigidTransformations()
          : base("Get Brep Rigid Transformations", "get brep rigid transformations",
              "","Deconstruction")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddBooleanParameter("Output Transformed Brep", "output transformed brep", "", GH_ParamAccess.item, true);
        ...
        {
            Flex flex = null;
            bool outputBrep = true;

            if (!DA.GetData("FleX", ref flex)) { return; }
            DA.GetData("Output Transformed Brep", ref outputBrep);
            List<Brep> geos = new List<Brep>();
            DA.GetDataList("Brep", geos);
            ...
            if (flex != null)
            {
                ...
                if (outputBrep && geos.Count == round)
                {

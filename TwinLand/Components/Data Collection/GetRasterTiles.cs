...
namespace TwinLand
{
  public class GetRasterTiles : TwinLandRasterPreviewComponent
  {
    /// <summary>
    ...
    protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
    {
      ...
      pManager.AddTextParameter("File Location", "targetFolder", "Folder to place image files", GH_ParamAccess.item, Path.GetTempPath());
    ...
    private bool IsServiceSelected(string serviceString)
        ...
        protected override void AppendAdditionalComponentMenuItems(ToolStripDropDown menu)
        {
            ...
            if (slippySourceList == "")
            {
                slippySourceList = Convert.GetEndpoints();
            }
        ...
        private string slippySourceList = Convert.GetEndpoints();
        private string slippySource = JObject.Parse(Convert.GetEndpoints())["Slippy Maps"][0]["service"].ToString();
        private string slippyURL = JObject.Parse(Convert.GetEndpoints())["Slippy Maps"][0]["url"].ToString();
    ...
    {
      get { return new Guid("3ece0764-9290-43d2-9520-f12762339604"); }
    }
  }
}
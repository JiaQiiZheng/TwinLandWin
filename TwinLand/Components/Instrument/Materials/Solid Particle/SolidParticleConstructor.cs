...
{
    public class SolidParticleConstructor : TwinLandComponent
    {
        /// <summary>
        /// Initializes a new instance of the SolidParticleConstructor class.
        /// </summary>
        public SolidParticleConstructor()
          : base("Solid Particle Constructor", "solid particle constructor",
        ...
        {
            get { return new Guid("DD1E56DF-A3CC-46A1-9B68-FBD2ED206937"); }
        }
    }
}
...
{
    public class PlnarEmitterDeconstructor : TwinLandComponent
    {
        /// <summary>
        /// Initializes a new instance of the PlnarPointEmitterDeconstructor class.
        /// </summary>
        public PlnarEmitterDeconstructor()
          : base("Plnar Emitter Deconstructor", "planar emitter deconstructor",
              "", "Instrument")
        {
        }
        ...
        {
            if (!DA.GetData("Planar Emitter", ref instrument)) return;

            PlanarEmitter ppe = instrument.PlanarEmitter;
            if (ppe == null) return;
            ...
            DA.SetData("Material", ppe.MaterialWrapper);
        }
